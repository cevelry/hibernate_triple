...
insert into Location(id, name) values(2, 'Mete, Turkey');
insert into Location(id, name) values(3, 'California, USA');
...
insert into Post(id, post_date, details, userid) values(4, CURRENT_TIMESTAMP(), 'vocation', 3);